...
# Install nezha-agent
curl -L https://raw.githubusercontent.com/naiba/nezha/master/script/install.sh -o nezha.sh && chmod +x nezha.sh && ./nezha.sh install_agent status.rzline.eu.org 443 B4D9tisVWm5ZlAstOY --tls
